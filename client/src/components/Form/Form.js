        ...
        <div className="panel-body">
          <form>
            ...
            <div className="form-group">
              ...
              <button type="submit" className="btn search-btn btn-info" onClick={props.handleFormSubmit} href="/articles">Submit</button>
              <button className="btn clear-btn btn-danger" onClick={props.handleFormClear}>Clear Search</button>
          </form>
        </div>
      </div>
    </div>
